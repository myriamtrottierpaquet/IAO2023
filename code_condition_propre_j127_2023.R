...
data_ajd <- read.csv("cond_IAO_aujourdhui_2023_127.csv",header = TRUE, sep= ";") ############ VERFIER QUE CEST LE BON FICHIER #######
...
capture_day <- 127 ################################################# VERFIER QUE CEST LE BON JOUR DE CAPTURE #######
catch_no <- 2       ####################### CHANGER AUSSI LE CATCH NUMBER
current_year <- 2023
...
chosen_ones <- data.frame(ring_ID = c('2127-43749', '2127-43747', #1
                                      '2127-43758', '2127-43756',  #2
                                      '2127-43746', '2127-43768' ),#3
...
write.table(chosen_to_save, file= paste0("chosen_ones_day_",capture_day, "capture_no_", "2", ".xls"))

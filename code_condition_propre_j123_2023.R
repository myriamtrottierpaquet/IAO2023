...
chosen_ones <- data.frame(ring_ID = c('2127-43703', '2127-43721', '2127-43742', #1
                                      '2127-43738', '2127-43704',  #2
                                      '2127-43741', '2127-43728' ),#3
                          pair_no = c(1, 1,1,  2, 2, 3, 3))                ############################ A MODIFIER SELON LES OIES CHOISIES ######

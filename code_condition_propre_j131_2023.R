...
data_ajd <- read.csv("cond_IAO_aujourdhui_2023_131.csv",header = TRUE, sep= ";") ############ VERFIER QUE CEST LE BON FICHIER #######
...
catch_no <- 5       ####################### CHANGER AUSSI LE CATCH NUMBER
current_year <- 2023
...
chosen_ones <- data.frame(ring_ID = c('2127-44177', '2127-44054', '2127-44125',#1
                                      '2127-44134', '2127-44028', '2127-44121',#2
                                      '2127-44031', '2127-44052',#3
                                      '2127-44148', '2127-44154',#4
                                      '2127-44076', '2127-44167'),#5
                          pair_no = c(1, 1,1, 2, 2, 2, 3, 3, 4, 4, 5, 5))                ############################ A MODIFIER SELON LES OIES CHOISIES ######
...
write.table(chosen_to_save, file= paste0("chosen_ones_day_",capture_day, "capture_no_", "5", ".xls"))

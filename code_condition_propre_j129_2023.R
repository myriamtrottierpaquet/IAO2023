...
data_ajd <- read.csv("cond_IAO_aujourdhui_2023_129.csv",header = TRUE, sep= ";") ############ VERFIER QUE CEST LE BON FICHIER #######
...
capture_day <- 129 ################################################# VERFIER QUE CEST LE BON JOUR DE CAPTURE #######
catch_no <- 3       ####################### CHANGER AUSSI LE CATCH NUMBER
current_year <- 2023
...
chosen_ones <- data.frame(ring_ID = c('2127-43840', '2127-43909', #1
                                      '2127-43907', '2127-43776', '2127-43912', #2
                                      '2127-43783', '2127-43777',#3
                                      '2127-43834', '2127-43914',#4
                                      '2127-43830', '2127-43833', '2127-43774'),#5
                          pair_no = c(1, 1, 2, 2, 2, 3, 3, 4, 4, 5, 5, 5))                ############################ A MODIFIER SELON LES OIES CHOISIES ######
...
write.table(chosen_to_save, file= paste0("chosen_ones_day_",capture_day, "capture_no_", "3", ".xls"))
